...
class Koi {
    ...
    draw() {
        ...
        wiz.beginPath();
        wiz.fillStyle = this.c2;
        wiz.moveTo(this.x+p[0],
                   this.y+p[1]);
        wiz.bezierCurveTo(this.x+p[2],
                          this.y+p[3],
                          this.x+p[4],
                          this.y+p[5],
                          this.x+p[6],
        ...
        wiz.beginPath()
        wiz.fillStyle = this.c2;
        wiz.moveTo(this.x+p[8],
                   this.y+p[9]);
        wiz.bezierCurveTo(this.x+p[10],
                          this.y+p[11],
                          this.x+p[12],
                          this.y+p[13],
                          this.x+p[14],
        ...
        wiz.fill()        
        wiz.beginPath();
        wiz.fillStyle = this.c1;
        wiz.moveTo(this.x+p[16],
                   this.y+p[17]);        
        wiz.bezierCurveTo(this.x+p[18],
                          this.y+p[19],
                          this.x+p[20],
                          this.y+p[21],
                          this.x+p[22],
                          this.y+p[23])
        wiz.bezierCurveTo(this.x+p[24],
                          this.y+p[25],
                          this.x+p[26],
                          this.y+p[27],
                          this.x+p[28],
        ...
        wiz.beginPath();
        wiz.fillStyle="black";
        wiz.arc(this.x+p[30],this.y+p[31],1,0,44/7);
        wiz.arc(this.x+p[32],this.y+p[33],1,0,44/7);
        wiz.fill();
        
        wiz.beginPath()
        wiz.strokeStyle = this.c2;
        wiz.lineWidth = .5;
        wiz.moveTo(this.x+p[34],
                   this.y+p[35]); 
        wiz.quadraticCurveTo(this.x+p[36],
                             this.y+p[37],
                             this.x+p[38],
                             this.y+p[39])
        wiz.stroke()
        ...
        wiz.beginPath()
        wiz.fillStyle = this.c2;
        wiz.moveTo(this.x+p[40],
                   this.y+p[41]); 
        wiz.quadraticCurveTo(this.x+p[42],
                             this.y+p[43],
                             this.x+p[44],
                             this.y+p[45])
        wiz.quadraticCurveTo(this.x+p[46],
                             this.y+p[47],
                             this.x+p[48],
                             this.y+p[49])                  
        wiz.fill();                  
...
const Loop = () => {
    wiz.fillStyle ="rgba(0,0,0,.12)"
    wiz.fillRect(0, 0, W, H)
    wiz.fillStyle = "red";
    wiz.fill()
